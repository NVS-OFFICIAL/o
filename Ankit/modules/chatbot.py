    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "ᴘʀᴏᴊᴇᴄᴛ-x ᴄʜᴀᴛʙᴏᴛ ᴅɪsᴀʙʟᴇᴅ ʙʏ {}.".format(mention_html(user.id, user.first_name)),
...
def kukiadd(update: Update, context: CallbackContext) -> str:
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "ᴘʀᴏᴊᴇᴄᴛ-x ᴄʜᴀᴛʙᴏᴛ ᴇɴᴀʙʟᴇᴅ ʙʏ {}.".format(mention_html(user.id, user.first_name)),
                parse_mode=ParseMode.HTML,
            )
...
def list_all_chats(update: Update, context: CallbackContext):
    ...
    text = "<b>Project-X Enabled Chats</b>\n"
    for chat in chats:
        try:
